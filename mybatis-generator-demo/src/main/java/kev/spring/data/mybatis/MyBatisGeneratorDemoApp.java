...
@Slf4j
@MapperScan("kev.spring.data.mybatis.mapper")
public class MyBatisGeneratorDemoApp implements ApplicationRunner {

    @Autowired
    private CoffeeMapper coffeeMapper;

    public static void main(String[] args) {
        SpringApplication.run(MyBatisGeneratorDemoApp.class, args);
    }
